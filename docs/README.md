...
| [contracts/entity-relations.md](contracts/entity-relations.md) | 엔티티 관계 계약 — 관계 어휘·방향·유효기간·병합 규칙, kind→DB 사상, 미해소·별칭 정책 ([adr/0039](adr/0039-entity-relation-schema.md)) | 엔티티 마스터·관계·해소를 만질 때 |
