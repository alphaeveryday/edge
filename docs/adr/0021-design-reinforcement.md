...
- 정정 = 리비전 분리 모델 확정: 구 item CORRECTED 종결 + supersedes 참조 신규 리비전 재점검 (**이 결정은 폐지됐다** — 정정 전달 자체가 [ADR-0044](0044-correction-abolition.md)로 사라졌다. 그 전의 라우팅 변경 이력은 [ADR-0041](0041-correction-same-screening.md))
