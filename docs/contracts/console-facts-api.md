...
🔴 **장중에는 R13 이 거짓 −100% 를 낸다**(B1 리뷰가 연 물음, 미해소). `outputs[].today` 는 수 하나라
"실측 0"과 "아직 안 찼다"를 못 가르는데, 산출은 하루 끝에 찬다 — 아침에 콘솔을 열면 다섯 산출이 전부
분포 밖으로 선다. **미래 날짜는 400 으로 막았지만**(아직 오지 않은 날은 사실 조회가 아니다) 오늘
