...
#
# 신설 이력(ALPHA-722): DISABLED로 병행 검증한 뒤 724에서 시장 SFN의 공시 4스텝을 옮겼다.
# 현재 dev(ALPHA-1071)는 장중 390창 수집과 평일 19:30 보충 배치를 함께 운영한다.
# 이 SFN은 배치 4작업을 담당하며 실제 활성 상태·시각은 envs/dev/main.tf가 정한다.
#
