...
<table class="retro-board">
  ...
  <tbody>
    <tr>
      <td>
        <ul>
          <li>매일 다 같이 일하는 시간을 맞춰 작업해 블로커에 대해 빠르게 논의하고 결정</li>
          <li>AI 활용하여 시간을 절약해, 중요한 것에 집중</li>
          <li>데일리 스크럼 진행</li>
        </ul>
      </td>
      <td>
        <ul>
          <li>스프린트 플래닝에서 작업의 우선순위를 고려하지 않아 블로커가 생겨 스프린트 미완료</li>
          <li>개발 시간과 설계 시간을 분배하지 못함</li>
          <li>빈번히 퇴근 시간이 늦어져 작업 효율 저하</li>
        </ul>
      </td>
      <td>
        <ul>
          <li>설계를 포함한 스프린트 플래닝</li>
          <li>한 가지 작업에 가용 시간을 정하고 그 이상은 사용하지 않음</li>
          <li>퇴근 시간 21시에 하고, 산정된 백로그를 모두 처리</li>
        </ul>
      </td>
    </tr>
  </tbody>
