...
사용:  python -m edge_analysis.statics.ops.expressive <ticker> <instrument_id> <YYYY-MM-DD> [n]
"""
...
from ..core.paneltest import FEATURES
from ..core.vocab import CHANNELS, OUTCOME_KINDS, RELATIONS, SERIES_FAMILIES, TRANSFORMS
...
def generate(ask, machine, *, facts: str, n: int = 4) -> list[str]:
    ...
    from ..core.hypothesize import explore
...
def survey_cell(lake, ask, ticker: str, instrument_id: str, day: str,
    ...
    from ..core.attribute import load_cell
    from ..core.fsm import Machine
