...
실행: python -m edge_analysis.statics.window.etfday <etf_id> <YYYY-MM-DD> [종목수]
"""
...
from ..core.layers import Rollup, decompose, market_source, overnight
...
def run_etf_day(lake: CausalLake, ask, etf: str, day: str, *, names: int = 5) -> str:
    ...
    from ..core.attribute import run_cell
