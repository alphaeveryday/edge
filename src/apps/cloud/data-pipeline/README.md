...
> 34초에 든다(참조 계열 48 편입 후 시점의 실측, ALPHA-842 — 그 뒤 ALPHA-927 이
> 091170 을 판정 축으로 옮기며 그 ETF 의 구성종목이 유니버스에 더해졌다). 토스 adapter 는 대체 소스로 남는다(`source=toss`). ⚠️ 뉴스 Consumer 는 실행 표면이 생겼고(ALPHA-713 —
