...
# 2026-09-07·19 dev 정상 런에서 같은 상장사를 가리키는 정식명·상호 표기만 둔다
# (ALPHA-1067·1080). 그룹명·브랜드·비상장 자회사처럼 상장 instrument 귀속이
...
_INSTRUMENT_ALIASES = {
    ...
    "한국지역난방공사": "지역난방공사",
    "한국타이어": "한국타이어앤테크놀로지",
    "한국타이어(한국타이어앤테크놀로지)": "한국타이어앤테크놀로지",
    "한국타이어앤테크놀로지(한국타이어)": "한국타이어앤테크놀로지",
    "디엑스앤브이엑스": "DXVX",
    "디엑스앤브이엑스(DXVX)": "DXVX",
    "디엑스앤브이엑스(Dx&Vx)": "DXVX",
    "삼성SDS": "삼성에스디에스",
