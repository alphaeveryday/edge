...
S3 write 와 PostgreSQL commit 은 한 트랜잭션이 아니다(v0.7 9절). 기본 legacy writer는
...
(local|s3)이 담당한다. content_v2 reader는 artifact_reader.py, writer와 DB 확정 연결은 worker.py가 제공한다.
"""
