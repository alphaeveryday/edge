...
# ── freshness_status / freshness_reason (ADR-0043) ──
FRESHNESS_UNKNOWN = "UNKNOWN"
FRESHNESS_FRESH = "FRESH"
FRESHNESS_STALE = "STALE"
FRESHNESS_STATUSES = frozenset({FRESHNESS_UNKNOWN, FRESHNESS_FRESH, FRESHNESS_STALE})
FRESHNESS_EVIDENCE_MISSING = "EVIDENCE_MISSING"
FRESHNESS_ACTUAL_AS_OF_UNVERIFIED = "ACTUAL_AS_OF_UNVERIFIED"
