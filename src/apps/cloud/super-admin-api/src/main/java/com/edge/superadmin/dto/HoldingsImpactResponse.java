 ...
 * 로그 소관이고, 이 응답은 "기대에 있었는데 이 런의 적재분에 없다"는 사실까지만 말한다.
 */
public record HoldingsImpactResponse(String runKey, String expectedAsOf,
		...
		List<MissingEtfResponse> missing, String recommendedAction) {
	...
	public static HoldingsImpactResponse empty() {
		return new HoldingsImpactResponse(null, null, null, 0, true, List.of(), null);
	}
}
