...
API 서버 4대·1,600 req/s 환경에서 캐시 전략을 75회 부하 테스트로 비교했습니다. 네 구성의 p99는 모두 1~2ms였고, Caffeine만으로 3분간 DB 조회가 288,000회에서 1,062회로 줄었습니다. 현재 규모에서는 Caffeine 단독 구성을 유지했습니다.
