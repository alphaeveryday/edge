...
| 5,000 | 13.7% | 160,271(2m) | 93,192(2m) | 1.7× | **12.0ms** |
...
- L2 도 유한: 상환 배율 6.2×→1.7× 감쇠(L2 유효 상한 예측 ~4,800 부합, N=5,000 L2 hit 41%). **대워킹셋 역효과**: two-level p99 가 N=5,000 에서 12.0ms(caffeine 2.4ms) — miss 마다 L2 왕복이 추가되는 비용이 미스율과 곱해짐.
